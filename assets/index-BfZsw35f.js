 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(z,K){var X=z.length;z.push(K);e:for(;0<X;){var ge=X-1>>>1,le=z[ge];if(0<i(le,K))z[ge]=K,z[X]=le,X=ge;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var K=z[0],X=z.pop();if(X!==K){z[0]=X;e:for(var ge=0,le=z.length,Se=le>>>1;ge<Se;){var sn=2*(ge+1)-1,on=z[sn],an=sn+1,ln=z[an];if(0>i(on,X))an<le&&0>i(ln,on)?(z[ge]=ln,z[an]=X,ge=an):(z[ge]=on,z[sn]=X,ge=sn);else if(an<le&&0>i(ln,X))z[ge]=ln,z[an]=X,ge=an;else break e}}return K}function i(z,K){var X=z.sortIndex-K.sortIndex;return X!==0?X:z.id-K.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,g=null,_=3,w=!1,P=!1,N=!1,b=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,y=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function k(z){for(var K=n(h);K!==null;){if(K.callback===null)r(h);else if(K.startTime<=z)r(h),K.sortIndex=K.expirationTime,e(u,K);else break;K=n(h)}}function O(z){if(N=!1,k(z),!P)if(n(u)!==null)P=!0,rn(M);else{var K=n(h);K!==null&&Ct(O,K.startTime-z)}}function M(z,K){P=!1,N&&(N=!1,I(m),m=-1),w=!0;var X=_;try{for(k(K),g=n(u);g!==null&&(!(g.expirationTime>K)||z&&!A());){var ge=g.callback;if(typeof ge=="function"){g.callback=null,_=g.priorityLevel;var le=ge(g.expirationTime<=K);K=t.unstable_now(),typeof le=="function"?g.callback=le:g===n(u)&&r(u),k(K)}else r(u);g=n(u)}if(g!==null)var Se=!0;else{var sn=n(h);sn!==null&&Ct(O,sn.startTime-K),Se=!1}return Se}finally{g=null,_=X,w=!1}}var D=!1,v=null,m=-1,E=5,S=-1;function A(){return!(t.unstable_now()-S<E)}function R(){if(v!==null){var z=t.unstable_now();S=z;var K=!0;try{K=v(!0,z)}finally{K?T():(D=!1,v=null)}}else D=!1}var T;if(typeof y=="function")T=function(){y(R)};else if(typeof MessageChannel<"u"){var pe=new MessageChannel,at=pe.port2;pe.port1.onmessage=R,T=function(){at.postMessage(null)}}else T=function(){b(R,0)};function rn(z){v=z,D||(D=!0,T())}function Ct(z,K){m=b(function(){z(t.unstable_now())},K)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_continueExecution=function(){P||w||(P=!0,rn(M))},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return _},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(z){switch(_){case 1:case 2:case 3:var K=3;break;default:K=_}var X=_;_=K;try{return z()}finally{_=X}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(z,K){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var X=_;_=z;try{return K()}finally{_=X}},t.unstable_scheduleCallback=function(z,K,X){var ge=t.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?ge+X:ge):X=ge,z){case 1:var le=-1;break;case 2:le=250;break;case 5:le=1073741823;break;case 4:le=1e4;break;default:le=5e3}return le=X+le,z={id:f++,callback:K,priorityLevel:z,startTime:X,expirationTime:le,sortIndex:-1},X>ge?(z.sortIndex=X,e(h,z),n(u)===null&&z===n(h)&&(N?(I(m),m=-1):N=!0,Ct(O,X-ge))):(z.sortIndex=le,e(u,z),P||w||(P=!0,rn(M))),z},t.unstable_shouldYield=A,t.unstable_wrapCallback=function(z){var K=_;return function(){var X=_;_=K;try{return z.apply(this,arguments)}finally{_=X}}}})(ey);Zg.exports=ey;var fw=Zg.exports;/**
 * @license React
...
*/var Cr,qv;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(v,m){function E(){}E.prototype=m.prototype,v.D=m.prototype,v.prototype=new E,v.prototype.constructor=v,v.C=function(S,A,R){for(var T=Array(arguments.length-2),pe=2;pe<arguments.length;pe++)T[pe-2]=arguments[pe];return m.prototype[A].apply(S,T)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(v,m,E){E||(E=0);var S=Array(16);if(typeof m=="string")for(var A=0;16>A;++A)S[A]=m.charCodeAt(E++)|m.charCodeAt(E++)<<8|m.charCodeAt(E++)<<16|m.charCodeAt(E++)<<24;else for(A=0;16>A;++A)S[A]=m[E++]|m[E++]<<8|m[E++]<<16|m[E++]<<24;m=v.g[0],E=v.g[1],A=v.g[2];var R=v.g[3],T=m+(R^E&(A^R))+S[0]+3614090360&4294967295;m=E+(T<<7&4294967295|T>>>25),T=R+(A^m&(E^A))+S[1]+3905402710&4294967295,R=m+(T<<12&4294967295|T>>>20),T=A+(E^R&(m^E))+S[2]+606105819&4294967295,A=R+(T<<17&4294967295|T>>>15),T=E+(m^A&(R^m))+S[3]+3250441966&4294967295,E=A+(T<<22&4294967295|T>>>10),T=m+(R^E&(A^R))+S[4]+4118548399&4294967295,m=E+(T<<7&4294967295|T>>>25),T=R+(A^m&(E^A))+S[5]+1200080426&4294967295,R=m+(T<<12&4294967295|T>>>20),T=A+(E^R&(m^E))+S[6]+2821735955&4294967295,A=R+(T<<17&4294967295|T>>>15),T=E+(m^A&(R^m))+S[7]+4249261313&4294967295,E=A+(T<<22&4294967295|T>>>10),T=m+(R^E&(A^R))+S[8]+1770035416&4294967295,m=E+(T<<7&4294967295|T>>>25),T=R+(A^m&(E^A))+S[9]+2336552879&4294967295,R=m+(T<<12&4294967295|T>>>20),T=A+(E^R&(m^E))+S[10]+4294925233&4294967295,A=R+(T<<17&4294967295|T>>>15),T=E+(m^A&(R^m))+S[11]+2304563134&4294967295,E=A+(T<<22&4294967295|T>>>10),T=m+(R^E&(A^R))+S[12]+1804603682&4294967295,m=E+(T<<7&4294967295|T>>>25),T=R+(A^m&(E^A))+S[13]+4254626195&4294967295,R=m+(T<<12&4294967295|T>>>20),T=A+(E^R&(m^E))+S[14]+2792965006&4294967295,A=R+(T<<17&4294967295|T>>>15),T=E+(m^A&(R^m))+S[15]+1236535329&4294967295,E=A+(T<<22&4294967295|T>>>10),T=m+(A^R&(E^A))+S[1]+4129170786&4294967295,m=E+(T<<5&4294967295|T>>>27),T=R+(E^A&(m^E))+S[6]+3225465664&4294967295,R=m+(T<<9&4294967295|T>>>23),T=A+(m^E&(R^m))+S[11]+643717713&4294967295,A=R+(T<<14&4294967295|T>>>18),T=E+(R^m&(A^R))+S[0]+3921069994&4294967295,E=A+(T<<20&4294967295|T>>>12),T=m+(A^R&(E^A))+S[5]+3593408605&4294967295,m=E+(T<<5&4294967295|T>>>27),T=R+(E^A&(m^E))+S[10]+38016083&4294967295,R=m+(T<<9&4294967295|T>>>23),T=A+(m^E&(R^m))+S[15]+3634488961&4294967295,A=R+(T<<14&4294967295|T>>>18),T=E+(R^m&(A^R))+S[4]+3889429448&4294967295,E=A+(T<<20&4294967295|T>>>12),T=m+(A^R&(E^A))+S[9]+568446438&4294967295,m=E+(T<<5&4294967295|T>>>27),T=R+(E^A&(m^E))+S[14]+3275163606&4294967295,R=m+(T<<9&4294967295|T>>>23),T=A+(m^E&(R^m))+S[3]+4107603335&4294967295,A=R+(T<<14&4294967295|T>>>18),T=E+(R^m&(A^R))+S[8]+1163531501&4294967295,E=A+(T<<20&4294967295|T>>>12),T=m+(A^R&(E^A))+S[13]+2850285829&4294967295,m=E+(T<<5&4294967295|T>>>27),T=R+(E^A&(m^E))+S[2]+4243563512&4294967295,R=m+(T<<9&4294967295|T>>>23),T=A+(m^E&(R^m))+S[7]+1735328473&4294967295,A=R+(T<<14&4294967295|T>>>18),T=E+(R^m&(A^R))+S[12]+2368359562&4294967295,E=A+(T<<20&4294967295|T>>>12),T=m+(E^A^R)+S[5]+4294588738&4294967295,m=E+(T<<4&4294967295|T>>>28),T=R+(m^E^A)+S[8]+2272392833&4294967295,R=m+(T<<11&4294967295|T>>>21),T=A+(R^m^E)+S[11]+1839030562&4294967295,A=R+(T<<16&4294967295|T>>>16),T=E+(A^R^m)+S[14]+4259657740&4294967295,E=A+(T<<23&4294967295|T>>>9),T=m+(E^A^R)+S[1]+2763975236&4294967295,m=E+(T<<4&4294967295|T>>>28),T=R+(m^E^A)+S[4]+1272893353&4294967295,R=m+(T<<11&4294967295|T>>>21),T=A+(R^m^E)+S[7]+4139469664&4294967295,A=R+(T<<16&4294967295|T>>>16),T=E+(A^R^m)+S[10]+3200236656&4294967295,E=A+(T<<23&4294967295|T>>>9),T=m+(E^A^R)+S[13]+681279174&4294967295,m=E+(T<<4&4294967295|T>>>28),T=R+(m^E^A)+S[0]+3936430074&4294967295,R=m+(T<<11&4294967295|T>>>21),T=A+(R^m^E)+S[3]+3572445317&4294967295,A=R+(T<<16&4294967295|T>>>16),T=E+(A^R^m)+S[6]+76029189&4294967295,E=A+(T<<23&4294967295|T>>>9),T=m+(E^A^R)+S[9]+3654602809&4294967295,m=E+(T<<4&4294967295|T>>>28),T=R+(m^E^A)+S[12]+3873151461&4294967295,R=m+(T<<11&4294967295|T>>>21),T=A+(R^m^E)+S[15]+530742520&4294967295,A=R+(T<<16&4294967295|T>>>16),T=E+(A^R^m)+S[2]+3299628645&4294967295,E=A+(T<<23&4294967295|T>>>9),T=m+(A^(E|~R))+S[0]+4096336452&4294967295,m=E+(T<<6&4294967295|T>>>26),T=R+(E^(m|~A))+S[7]+1126891415&4294967295,R=m+(T<<10&4294967295|T>>>22),T=A+(m^(R|~E))+S[14]+2878612391&4294967295,A=R+(T<<15&4294967295|T>>>17),T=E+(R^(A|~m))+S[5]+4237533241&4294967295,E=A+(T<<21&4294967295|T>>>11),T=m+(A^(E|~R))+S[12]+1700485571&4294967295,m=E+(T<<6&4294967295|T>>>26),T=R+(E^(m|~A))+S[3]+2399980690&4294967295,R=m+(T<<10&4294967295|T>>>22),T=A+(m^(R|~E))+S[10]+4293915773&4294967295,A=R+(T<<15&4294967295|T>>>17),T=E+(R^(A|~m))+S[1]+2240044497&4294967295,E=A+(T<<21&4294967295|T>>>11),T=m+(A^(E|~R))+S[8]+1873313359&4294967295,m=E+(T<<6&4294967295|T>>>26),T=R+(E^(m|~A))+S[15]+4264355552&4294967295,R=m+(T<<10&4294967295|T>>>22),T=A+(m^(R|~E))+S[6]+2734768916&4294967295,A=R+(T<<15&4294967295|T>>>17),T=E+(R^(A|~m))+S[13]+1309151649&4294967295,E=A+(T<<21&4294967295|T>>>11),T=m+(A^(E|~R))+S[4]+4149444226&4294967295,m=E+(T<<6&4294967295|T>>>26),T=R+(E^(m|~A))+S[11]+3174756917&4294967295,R=m+(T<<10&4294967295|T>>>22),T=A+(m^(R|~E))+S[2]+718787259&4294967295,A=R+(T<<15&4294967295|T>>>17),T=E+(R^(A|~m))+S[9]+3951481745&4294967295,v.g[0]=v.g[0]+m&4294967295,v.g[1]=v.g[1]+(A+(T<<21&4294967295|T>>>11))&4294967295,v.g[2]=v.g[2]+A&4294967295,v.g[3]=v.g[3]+R&4294967295}r.prototype.u=function(v,m){m===void 0&&(m=v.length);for(var E=m-this.blockSize,S=this.B,A=this.h,R=0;R<m;){if(A==0)for(;R<=E;)i(this,v,R),R+=this.blockSize;if(typeof v=="string"){for(;R<m;)if(S[A++]=v.charCodeAt(R++),A==this.blockSize){i(this,S),A=0;break}}else for(;R<m;)if(S[A++]=v[R++],A==this.blockSize){i(this,S),A=0;break}}this.h=A,this.o+=m},r.prototype.v=function(){var v=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);v[0]=128;for(var m=1;m<v.length-8;++m)v[m]=0;var E=8*this.o;for(m=v.length-8;m<v.length;++m)v[m]=E&255,E/=256;for(this.u(v),v=Array(16),m=E=0;4>m;++m)for(var S=0;32>S;S+=8)v[E++]=this.g[m]>>>S&255;return v};function s(v,m){var E=l;return Object.prototype.hasOwnProperty.call(E,v)?E[v]:E[v]=m(v)}function o(v,m){this.h=m;for(var E=[],S=!0,A=v.length-1;0<=A;A--){var R=v[A]|0;S&&R==m||(E[A]=R,S=!1)}this.g=E}var l={};function u(v){return-128<=v&&128>v?s(v,function(m){return new o([m|0],0>m?-1:0)}):new o([v|0],0>v?-1:0)}function h(v){if(isNaN(v)||!isFinite(v))return g;if(0>v)return b(h(-v));for(var m=[],E=1,S=0;v>=E;S++)m[S]=v/E|0,E*=4294967296;return new o(m,0)}function f(v,m){if(v.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(v.charAt(0)=="-")return b(f(v.substring(1),m));if(0<=v.indexOf("-"))throw Error('number format error: interior "-" character');for(var E=h(Math.pow(m,8)),S=g,A=0;A<v.length;A+=8){var R=Math.min(8,v.length-A),T=parseInt(v.substring(A,A+R),m);8>R?(R=h(Math.pow(m,R)),S=S.j(R).add(h(T))):(S=S.j(E),S=S.add(h(T)))}return S}var g=u(0),_=u(1),w=u(16777216);t=o.prototype,t.m=function(){if(N(this))return-b(this).m();for(var v=0,m=1,E=0;E<this.g.length;E++){var S=this.i(E);v+=(0<=S?S:4294967296+S)*m,m*=4294967296}return v},t.toString=function(v){if(v=v||10,2>v||36<v)throw Error("radix out of range: "+v);if(P(this))return"0";if(N(this))return"-"+b(this).toString(v);for(var m=h(Math.pow(v,6)),E=this,S="";;){var A=O(E,m).g;E=I(E,A.j(m));var R=((0<E.g.length?E.g[0]:E.h)>>>0).toString(v);if(E=A,P(E))return R+S;for(;6>R.length;)R="0"+R;S=R+S}},t.i=function(v){return 0>v?0:v<this.g.length?this.g[v]:this.h};function P(v){if(v.h!=0)return!1;for(var m=0;m<v.g.length;m++)if(v.g[m]!=0)return!1;return!0}function N(v){return v.h==-1}t.l=function(v){return v=I(this,v),N(v)?-1:P(v)?0:1};function b(v){for(var m=v.g.length,E=[],S=0;S<m;S++)E[S]=~v.g[S];return new o(E,~v.h).add(_)}t.abs=function(){return N(this)?b(this):this},t.add=function(v){for(var m=Math.max(this.g.length,v.g.length),E=[],S=0,A=0;A<=m;A++){var R=S+(this.i(A)&65535)+(v.i(A)&65535),T=(R>>>16)+(this.i(A)>>>16)+(v.i(A)>>>16);S=T>>>16,R&=65535,T&=65535,E[A]=T<<16|R}return new o(E,E[E.length-1]&-2147483648?-1:0)};function I(v,m){return v.add(b(m))}t.j=function(v){if(P(this)||P(v))return g;if(N(this))return N(v)?b(this).j(b(v)):b(b(this).j(v));if(N(v))return b(this.j(b(v)));if(0>this.l(w)&&0>v.l(w))return h(this.m()*v.m());for(var m=this.g.length+v.g.length,E=[],S=0;S<2*m;S++)E[S]=0;for(S=0;S<this.g.length;S++)for(var A=0;A<v.g.length;A++){var R=this.i(S)>>>16,T=this.i(S)&65535,pe=v.i(A)>>>16,at=v.i(A)&65535;E[2*S+2*A]+=T*at,y(E,2*S+2*A),E[2*S+2*A+1]+=R*at,y(E,2*S+2*A+1),E[2*S+2*A+1]+=T*pe,y(E,2*S+2*A+1),E[2*S+2*A+2]+=R*pe,y(E,2*S+2*A+2)}for(S=0;S<m;S++)E[S]=E[2*S+1]<<16|E[2*S];for(S=m;S<2*m;S++)E[S]=0;return new o(E,0)};function y(v,m){for(;(v[m]&65535)!=v[m];)v[m+1]+=v[m]>>>16,v[m]&=65535,m++}function k(v,m){this.g=v,this.h=m}function O(v,m){if(P(m))throw Error("division by zero");if(P(v))return new k(g,g);if(N(v))return m=O(b(v),m),new k(b(m.g),b(m.h));if(N(m))return m=O(v,b(m)),new k(b(m.g),m.h);if(30<v.g.length){if(N(v)||N(m))throw Error("slowDivide_ only works with positive integers.");for(var E=_,S=m;0>=S.l(v);)E=M(E),S=M(S);var A=D(E,1),R=D(S,1);for(S=D(S,2),E=D(E,2);!P(S);){var T=R.add(S);0>=T.l(v)&&(A=A.add(E),R=T),S=D(S,1),E=D(E,1)}return m=I(v,A.j(m)),new k(A,m)}for(A=g;0<=v.l(m);){for(E=Math.max(1,Math.floor(v.m()/m.m())),S=Math.ceil(Math.log(E)/Math.LN2),S=48>=S?1:Math.pow(2,S-48),R=h(E),T=R.j(m);N(T)||0<T.l(v);)E-=S,R=h(E),T=R.j(m);P(R)&&(R=_),A=A.add(R),v=I(v,T)}return new k(A,v)}t.A=function(v){return O(this,v).h},t.and=function(v){for(var m=Math.max(this.g.length,v.g.length),E=[],S=0;S<m;S++)E[S]=this.i(S)&v.i(S);return new o(E,this.h&v.h)},t.or=function(v){for(var m=Math.max(this.g.length,v.g.length),E=[],S=0;S<m;S++)E[S]=this.i(S)|v.i(S);return new o(E,this.h|v.h)},t.xor=function(v){for(var m=Math.max(this.g.length,v.g.length),E=[],S=0;S<m;S++)E[S]=this.i(S)^v.i(S);return new o(E,this.h^v.h)};function M(v){for(var m=v.g.length+1,E=[],S=0;S<m;S++)E[S]=v.i(S)<<1|v.i(S-1)>>>31;return new o(E,v.h)}function D(v,m){var E=m>>5;m%=32;for(var S=v.g.length-E,A=[],R=0;R<S;R++)A[R]=0<m?v.i(R+E)>>>m|v.i(R+E+1)<<32-m:v.i(R+E);return new o(A,v.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,qv=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,Cr=o}).apply(typeof Qm<"u"?Qm:typeof self<"u"?self:typeof window<"u"?window:{});var da=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const GR=new Ee(H.comparator);function Pn(){return GR}const h0=new Ee(H.comparator);function Es(...t){let e=h0;for(const n of t)e=e.insert(n.key,n);return e}function d0(t){let e=h0;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Rr(){return bs()}function f0(){return bs()}function bs(){return new $i(t=>t.toString(),(t,e)=>t.isEqual(e))}const QR=new Ee(H.comparator),YR=new ze(H.comparator);function ee(...t){let e=YR;for(const n of t)e=e.add(n);return e}const XR=new ze(se);function JR(){return XR}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zA{constructor(){this.sessionToken=$e.EMPTY_BYTE_STRING}getSessionToken(e){return L.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,L.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $A{constructor(e){this.Mr=e,this.docs=function(){return new Ee(H.comparator)}(),this.size=0}setIndexManager(e){this.indexManager=e}addEntry(e,n){const r=n.key,i=this.docs.get(r),s=i?i.size:0,o=this.Mr(n);return this.docs=this.docs.insert(r,{document:n.mutableCopy(),size:o}),this.size+=o-s,this.indexManager.addToCollectionParentIndex(e,r.path.popLast())}removeEntry(e){const n=this.docs.get(e);n&&(this.docs=this.docs.remove(e),this.size-=n.size)}getEntry(e,n){const r=this.docs.get(n);return L.resolve(r?r.document.mutableCopy():Je.newInvalidDocument(n))}getEntries(e,n){let r=Pn();return n.forEach(i=>{const s=this.docs.get(i);r=r.insert(i,s?s.document.mutableCopy():Je.newInvalidDocument(i))}),L.resolve(r)}getDocumentsMatchingQuery(e,n,r,i){let s=Pn();const o=n.path,l=new H(o.child("")),u=this.docs.getIteratorFrom(l);for(;u.hasNext();){const{key:h,value:{document:f}}=u.getNext();if(!o.isPrefixOf(h.path))break;h.path.length>o.length+1||SR(IR(f),r)<=0||(i.has(f.key)||Yl(n,f))&&(s=s.insert(f.key,f.mutableCopy()))}return L.resolve(s)}getAllFromCollectionGroup(e,n,r,i){G()}Or(e,n){return L.forEach(this.docs,r=>n(r))}newChangeBuffer(e){return new WA(this)}getSize(e){return L.resolve(this.size)}}class WA extends LA{constructor(e){super(),this.cr=e}applyChanges(e){const n=[];return this.changes.forEach((r,i)=>{i.isValidDocument()?n.push(this.cr.addEntry(e,i)):this.cr.removeEntry(r)}),L.waitFor(n)}getFromCache(e,n){return this.cr.getEntry(e,n)}getAllFromCache(e,n){return this.cr.getEntries(e,n)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QA{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return DI()?8:AR(et())>0?6:4}()}initialize(e,n){this.Ji=e,this.indexManager=n,this.Gi=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.Yi(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Zi(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new GA;return this.Xi(e,n,o).next(l=>{if(s.result=l,this.zi)return this.es(e,n,o,l.size)})}).next(()=>s.result)}es(e,n,r,i){return r.documentReadCount<this.ji?(ds()<=te.DEBUG&&$("QueryEngine","SDK will not create cache indexes for query:",Xr(n),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),L.resolve()):(ds()<=te.DEBUG&&$("QueryEngine","Query:",Xr(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Hi*i?(ds()<=te.DEBUG&&$("QueryEngine","The SDK decides to create cache indexes for query:",Xr(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Yt(n))):L.resolve())}Yi(e,n){if(og(n))return L.resolve(null);let r=Yt(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=gh(n,null,"F"),r=Yt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=ee(...s);return this.Ji.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const h=this.ts(n,l);return this.ns(n,h,o,u.readTime)?this.Yi(e,gh(n,null,"F")):this.rs(e,h,n,u)}))})))}Zi(e,n,r,i){return og(n)||i.isEqual(Q.min())?L.resolve(null):this.Ji.getDocuments(e,r).next(s=>{const o=this.ts(n,s);return this.ns(n,o,r,i)?L.resolve(null):(ds()<=te.DEBUG&&$("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Xr(n)),this.rs(e,o,n,TR(i,-1)).next(l=>l))})}ts(e,n){let r=new ze(c0(e));return n.forEach((i,s)=>{Yl(e,s)&&(r=r.add(s))}),r}ns(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Xi(e,n,r){return ds()<=te.DEBUG&&$("QueryEngine","Using full collection scan to execute query:",Xr(n)),this.Ji.getDocumentsMatchingQuery(e,n,lr.min(),r)}rs(e,n,r,i){return this.Ji.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=Lt.makeFromUrl(e,n)}catch{return new Lt(e,"")}if(r.path==="")return r;throw DC(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(O){O.path.charAt(O.path.length-1)==="/"&&(O.path_=O.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+i+o,"i"),u={bucket:1,path:3};function h(O){O.path_=decodeURIComponent(O.path)}const f="v[A-Za-z0-9_]+",g=n.replace(/[.]/g,"\\."),_="(/([^?#]*).*)?$",w=new RegExp(`^https?://${g}/${f}/b/${i}/o${_}`,"i"),P={bucket:1,path:3},N=n===lE?"(?:storage.googleapis.com|storage.cloud.google.com)":n,b="([^?#]*)",I=new RegExp(`^https?://${N}/${i}/${b}`,"i"),k=[{regex:l,indices:u,postModify:s},{regex:w,indices:P,postModify:h},{regex:I,indices:{bucket:1,path:2},postModify:h}];for(let O=0;O<k.length;O++){const M=k[O],D=M.regex.exec(e);if(D){const v=D[M.indices.bucket];let m=D[M.indices.path];m||(m=""),r=new Lt(v,m),M.postModify(r);break}}if(r==null)throw NC(e);return r}}class bC{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function VC(t,e,n){let r=1,i=null,s=null,o=!1,l=0;function u(){return l===2}let h=!1;function f(...b){h||(h=!0,e.apply(null,b))}function g(b){i=setTimeout(()=>{i=null,t(w,u())},b)}function _(){s&&clearTimeout(s)}function w(b,...I){if(h){_();return}if(b){_(),f.call(null,b,...I);return}if(u()||o){_(),f.call(null,b,...I);return}r<64&&(r*=2);let k;l===1?(l=2,k=0):k=(r+Math.random())*1e3,g(k)}let P=!1;function N(b){P||(P=!0,_(),!h&&(i!==null?(b||(l=2),clearTimeout(i),g(0)):b||(l=1)))}return g(0),s=setTimeout(()=>{o=!0,N(!0)},n),N}function LC(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
淡路シーサイドマンション
自家用ジェット
自家用ロケット`}]}};function Ug(t,e){var g,_;const n=(g=t[0])!=null&&g[0]?String(t[0][0]):e,r=e.includes("アクション")||e.includes("月"),i={};[[2,3],[4,5],[6,7]].forEach(([w,P])=>{var N,b;for(let I=1;I<=3;I++){const y=(N=t[w])!=null&&N[I]?String(t[w][I]).trim():"",k=(b=t[P])!=null&&b[I]?String(t[P][I]):"";y&&(i[y]=k.replace(/\\n/g,`
`).trim())}});let s="",o=[];const l=Object.keys(i).find(w=>w.includes("テーマ"));if(l){const P=i[l].split(`
`).map(N=>N.trim()).filter(Boolean);s=P[0]||"",o=P.filter(N=>N.startsWith("☆")||N.startsWith("●")||N.includes("ワクワク")||N.includes("幸せ")||N.includes("悦び")||N.includes("♪")).map(N=>N.replace(/^[☆●]/,"").trim()),delete i[l]}const u=dE.map(w=>{const P=Object.keys(i).find(I=>tx[I]===w.id),N=P?i[P]:"",b=N?N.split(`
`).map(I=>I.replace(/^[🔲□■・]/,"").trim()).filter(Boolean):[];return{...w,tasks:b}}),h=u.find(w=>w.id==="health"),f=[];return(_=h==null?void 0:h.tasks)!=null&&_.length&&h.tasks.forEach(w=>{const P=w.indexOf("："),N=w.indexOf(":"),b=P>=0?P:N;b>=0?f.push({label:w.slice(0,b).trim(),value:w.slice(b+1).trim()}):f.push({label:w,value:""})}),{title:n,theme:s,emotionTags:o,sections:u,healthItems:f,isMonthly:r,catMap:i}}function ix(){const[t,e]=J.useState(void 0),[n,r]=J.useState("monthly"),[i,s]=J.useState(null),[o,l]=J.useState(!1),[u,h]=J.useState({show:!1,msg:""}),[f,g]=J.useState(!1),[_,w]=J.useState(!1),[P,N]=J.useState(!1),b=J.useRef(null),I=new Date,[y,k]=J.useState(I.getFullYear()),[O,M]=J.useState(I.getMonth()+1);J.useEffect(()=>Z1(Ls,R=>e(R??null)),[]),J.useEffect(()=>{if(!t)return;s(null);const R=`${t.uid}_${y}_${String(O).padStart(2,"0")}`;vC(xg(Mg,"futuremaps",R)).then(T=>{s(T.exists()?T.data():nx(y,O))})},[t,y,O]);const D=J.useCallback(async R=>{if(!t||!i)return;l(!0);const T=`${t.uid}_${y}_${String(O).padStart(2,"0")}`,pe={...i,...R,uid:t.uid,updatedAt:SC()};try{await wC(xg(Mg,"futuremaps",T),pe),s(pe)}catch(at){console.error(at)}l(!1)},[t,i,y,O]),v=(R,T)=>{const pe=`${R}:${T}`,at={...i.checked,[pe]:!i.checked[pe]};if(D({checked:at}),!i.checked[pe]){const rn=Fg[Math.floor(Math.random()*Fg.length)];h({show:!0,msg:rn}),clearTimeout(b.current),b.current=setTimeout(()=>h(Ct=>({...Ct,show:!1})),2600)}},m=R=>{D({openSecs:{...i.openSecs,[R]:!i.openSecs[R]}})},E=R=>{R===-1?O===1?(k(T=>T-1),M(12)):M(T=>T-1):O===12?(k(T=>T+1),M(1)):M(T=>T+1)},S=J.useCallback(R=>{var pe,at;const T={sections:R.sections,checked:{},openSecs:{}};R.theme&&(T.theme=R.theme),(pe=R.emotionTags)!=null&&pe.length&&(T.emotionTags=R.emotionTags),(at=R.healthItems)!=null&&at.length&&(T.health=R.healthItems.length>0?R.healthItems:(i==null?void 0:i.health)||[]),D(T),N(!1),h({show:!0,msg:"📊 Excelからインポートしました！"}),clearTimeout(b.current),b.current=setTimeout(()=>h(rn=>({...rn,show:!1})),3e3)},[D,i]);if(t===void 0)return C.jsx(jg,{msg:"読み込み中..."});if(t===null)return C.jsx(lx,{});if(n==="monthly"&&!i)return C.jsx(jg,{msg:"データを取得中..."});const A=[{id:"monthly",label:"📅 毎月"},{id:"1year",label:"🌱 1年後"},{id:"3year",label:"🌿 3年後"},{id:"10year",label:"🌳 10年後"}];return C.jsxs("div",{style:{fontFamily:"'Zen Maru Gothic',sans-serif",background:"#f1f8f4",minHeight:"100vh",color:"#1a3c2a",maxWidth:640,margin:"0 auto"},children:[C.jsx("style",{children:`
      ...
      `}),C.jsxs("header",{style:{background:"linear-gradient(135deg,#1b4332,#2d6a4f 55%,#1b4332)",color:"#f0faf4",padding:"16px 18px 0",position:"relative",overflow:"hidden"},children:[C.jsx("div",{style:{position:"absolute",top:-40,right:-40,width:160,height:160,borderRadius:"50%",background:"radial-gradient(circle,rgba(56,161,105,.25),transparent 70%)",pointerEvents:"none"}}),C.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14,position:"relative",zIndex:1},children:[C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:17,fontWeight:700,color:"#d4edda"},children:"🌿 フューチャーマップ"}),C.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[o&&C.jsx("span",{style:{fontSize:10,color:"rgba(255,255,255,.4)"},children:"保存中…"}),n==="monthly"&&C.jsx("button",{onClick:()=>N(!0),style:{background:"rgba(255,255,255,.15)",border:"1px solid rgba(255,255,255,.25)",color:"rgba(255,255,255,.9)",padding:"4px 10px",borderRadius:16,fontSize:11,fontFamily:"'Zen Maru Gothic',sans-serif",cursor:"pointer",display:"flex",alignItems:"center",gap:4},children:"📊 Excel"}),C.jsx("div",{style:{width:28,height:28,borderRadius:"50%",background:"rgba(255,255,255,.2)",border:"2px solid rgba(255,255,255,.25)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:13},children:"👤"}),C.jsx("button",{onClick:()=>w(!0),style:{background:"rgba(255,255,255,.1)",border:"1px solid rgba(255,255,255,.18)",color:"rgba(255,255,255,.75)",padding:"4px 10px",borderRadius:16,fontSize:11,fontFamily:"'Zen Maru Gothic',sans-serif",cursor:"pointer"},children:"ログアウト"})]})]}),C.jsx("div",{style:{display:"flex",gap:3,position:"relative",zIndex:1},children:A.map(R=>C.jsx("button",{onClick:()=>r(R.id),style:{flex:1,padding:"9px 3px",border:"none",cursor:"pointer",fontFamily:"'Zen Maru Gothic',sans-serif",fontSize:11,fontWeight:700,borderRadius:"8px 8px 0 0",transition:"all .2s",background:n===R.id?"#f1f8f4":"rgba(255,255,255,.1)",color:n===R.id?"#1b4332":"rgba(255,255,255,.75)"},children:R.label},R.id))})]}),n==="monthly"?C.jsx(ox,{data:i,year:y,month:O,changeMonth:E,toggleTask:v,toggleSec:m,onEdit:()=>g(!0)}):C.jsx(ax,{visionKey:n}),u.msg&&C.jsx("div",{className:u.show?"ti":"to",style:{position:"fixed",bottom:28,left:"50%",transform:"translateX(-50%) translateY(70px)",background:"linear-gradient(135deg,#38a169,#2d6a4f)",color:"white",padding:"11px 22px",borderRadius:28,fontSize:13,fontWeight:700,boxShadow:"0 6px 22px rgba(56,161,105,.4)",zIndex:1e3,whiteSpace:"nowrap"},children:u.msg}),f&&i&&C.jsx(ux,{data:i,onSave:R=>{D(R),g(!1)},onClose:()=>g(!1)}),P&&C.jsx(sx,{year:y,month:O,onImport:S,onClose:()=>N(!1)}),_&&C.jsx("div",{onClick:()=>w(!1),style:{position:"fixed",inset:0,background:"rgba(26,60,42,.55)",zIndex:9999,display:"flex",alignItems:"center",justifyContent:"center",padding:24},children:C.jsxs("div",{onClick:R=>R.stopPropagation(),style:{background:"white",borderRadius:20,padding:"28px 24px",width:"100%",maxWidth:320,textAlign:"center",boxShadow:"0 8px 32px rgba(26,60,42,.2)"},children:[C.jsx("div",{style:{fontSize:36,marginBottom:12},children:"🌿"}),C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:17,fontWeight:700,color:"#1a3c2a",marginBottom:8},children:"ログアウトしますか？"}),C.jsxs("div",{style:{fontSize:12,color:"#7aab8a",marginBottom:24,lineHeight:1.7},children:["データはクラウドに保存されています。",C.jsx("br",{}),"次回ログイン時も続きから使えます。"]}),C.jsxs("div",{style:{display:"flex",gap:10},children:[C.jsx("button",{onClick:()=>w(!1),style:{flex:1,background:"rgba(26,60,42,.07)",border:"none",borderRadius:11,padding:"12px",fontSize:13,fontWeight:700,color:"#2d5a3d",fontFamily:"'Zen Maru Gothic',sans-serif",cursor:"pointer"},children:"キャンセル"}),C.jsx("button",{onClick:()=>{ek(Ls),w(!1)},style:{flex:1,background:"linear-gradient(135deg,#38a169,#2d6a4f)",border:"none",borderRadius:11,padding:"12px",fontSize:13,fontWeight:700,color:"white",fontFamily:"'Zen Maru Gothic',sans-serif",cursor:"pointer",boxShadow:"0 4px 12px rgba(56,161,105,.3)"},children:"ログアウト"})]})]})})]})}function sx({year:t,month:e,onImport:n,onClose:r}){const[i,s]=J.useState("drop"),[o,l]=J.useState([]),[u,h]=J.useState(null),[f,g]=J.useState(null),[_,w]=J.useState(""),[P,N]=J.useState(null),b=J.useRef(null),I=J.useRef(null);J.useEffect(()=>{if(window.XLSX){N(window.XLSX);return}const D=document.createElement("script");D.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",D.onload=()=>N(window.XLSX),document.head.appendChild(D)},[]);const y=D=>{if(!D||!P){w("ファイルを選択してください");return}if(!D.name.match(/\.xlsx?$/i)){w("xlsx ファイルを選択してください");return}w("");const v=new FileReader;v.onload=m=>{try{const E=P.read(m.target.result,{type:"array"}),S=E.SheetNames.map(R=>{const T=E.Sheets[R],pe=P.utils.sheet_to_json(T,{header:1,defval:""});return{name:R,data:pe}});l(S);const A=S.find(R=>R.name.includes("アクション"))||S[0];h(A.name),g(Ug(A.data,A.name)),s("preview")}catch(E){w("読み込みエラー: "+E.message)}},v.readAsArrayBuffer(D)},k=D=>{h(D);const v=o.find(m=>m.name===D);v&&g(Ug(v.data,v.name))},O=D=>{var v;D.preventDefault(),(v=b.current)==null||v.classList.remove("over"),y(D.dataTransfer.files[0])},M={flex:1,border:"none",borderRadius:11,padding:"11px",fontSize:13,fontWeight:700,fontFamily:"'Zen Maru Gothic',sans-serif",cursor:"pointer"};return C.jsx("div",{onClick:D=>D.target===D.currentTarget&&r(),style:{position:"fixed",inset:0,background:"rgba(26,60,42,.55)",zIndex:600,display:"flex",alignItems:"flex-end",justifyContent:"center"},children:C.jsxs("div",{className:"mi",style:{background:"#f4fbf6",borderRadius:"22px 22px 0 0",width:"100%",maxWidth:640,maxHeight:"90vh",overflow:"hidden",display:"flex",flexDirection:"column"},children:[C.jsx("div",{style:{width:38,height:4,background:"#7aab8a",borderRadius:2,margin:"14px auto 0",opacity:.4}}),C.jsxs("div",{style:{padding:"12px 18px 10px",borderBottom:"1px solid rgba(56,161,105,.13)"},children:[C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:16,fontWeight:700,color:"#2d6a4f"},children:"📊 Excel からインポート"}),C.jsxs("div",{style:{fontSize:11,color:"#7aab8a",marginTop:3},children:[t,"年",hE[e-1],"のアクションプランを読み込みます"]})]}),C.jsxs("div",{style:{overflowY:"auto",flex:1,padding:"14px 18px"},children:[i==="drop"&&C.jsxs(C.Fragment,{children:[C.jsxs("div",{ref:b,className:"xl-drop",onDragOver:D=>{var v;D.preventDefault(),(v=b.current)==null||v.classList.add("over")},onDragLeave:()=>{var D;return(D=b.current)==null?void 0:D.classList.remove("over")},onDrop:O,onClick:()=>{var D;return(D=I.current)==null?void 0:D.click()},children:[C.jsx("div",{style:{fontSize:36,marginBottom:10},children:"📊"}),C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:14,fontWeight:700,color:"#2d6a4f",marginBottom:6},children:"Excelファイルをドロップ"}),C.jsx("div",{style:{fontSize:12,color:"#7aab8a",marginBottom:12},children:"FutureMap202604.xlsx などをここにドラッグ"}),C.jsx("div",{style:{display:"inline-block",background:"#38a169",color:"white",padding:"8px 20px",borderRadius:20,fontSize:12,fontWeight:700,fontFamily:"'Zen Maru Gothic',sans-serif"},children:"ファイルを選択"}),C.jsx("input",{ref:I,type:"file",accept:".xlsx,.xls",style:{display:"none"},onChange:D=>y(D.target.files[0])})]}),_&&C.jsx("div",{style:{marginTop:10,fontSize:12,color:"#e53e3e",background:"#fff5f5",borderRadius:8,padding:"8px 12px"},children:_}),!P&&C.jsx("div",{style:{marginTop:8,fontSize:11,color:"#7aab8a",textAlign:"center"},children:"ライブラリ読み込み中..."})]}),i==="preview"&&f&&C.jsxs(C.Fragment,{children:[C.jsxs("div",{style:{marginBottom:10},children:[C.jsx("div",{style:{fontSize:11,color:"#7aab8a",marginBottom:6},children:"シートを選択："}),C.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:4},children:o.map(D=>C.jsx("button",{className:`xl-sheet-btn${u===D.name?" active":""}`,onClick:()=>k(D.name),children:D.name},D.name))})]}),f.theme&&C.jsxs("div",{style:{background:"#e8f5e9",border:"1px solid #b7e4c7",borderRadius:10,padding:"10px 14px",marginBottom:10},children:[C.jsx("div",{style:{fontSize:11,color:"#5a9e6f",fontWeight:700,marginBottom:4},children:"💕 テーマ"}),C.jsx("div",{style:{fontSize:12,color:"#1a3c2a",lineHeight:1.7},children:f.theme})]}),C.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:10},children:f.sections.filter(D=>D.tasks.length>0).map(D=>{const v=hr[D.color]||hr.rose;return C.jsxs("div",{style:{background:"white",border:"1px solid rgba(56,161,105,.15)",borderRadius:10,padding:"9px 11px"},children:[C.jsxs("div",{style:{fontSize:11,fontWeight:700,color:v.accent,marginBottom:5},children:[D.icon," ",D.name]}),D.tasks.slice(0,4).map((m,E)=>C.jsxs("div",{style:{fontSize:11,color:"#1a3c2a",lineHeight:1.6,borderBottom:E<Math.min(D.tasks.length,4)-1?"1px solid rgba(56,161,105,.07)":"none",padding:"2px 0"},children:["• ",m]},E)),D.tasks.length>4&&C.jsxs("div",{style:{fontSize:10,color:"#7aab8a",marginTop:3},children:["他 ",D.tasks.length-4," 件…"]})]},D.id)})}),f.sections.every(D=>D.tasks.length===0)&&C.jsxs("div",{style:{textAlign:"center",padding:"20px",color:"#7aab8a",fontSize:13},children:["タスクデータが見つかりませんでした。",C.jsx("br",{}),"別のシートを選んでください。"]})]})]}),C.jsxs("div",{style:{padding:"10px 18px 30px",display:"flex",gap:9,borderTop:"1px solid rgba(56,161,105,.13)"},children:[C.jsx("button",{onClick:i==="preview"?()=>s("drop"):r,style:{...M,background:"rgba(26,60,42,.07)",color:"#2d5a3d"},children:i==="preview"?"← 戻る":"キャンセル"}),i==="preview"&&f&&C.jsx("button",{onClick:()=>{const D=new Date,v=f.excelYear&&f.excelYear>2e3?f.excelYear:D.getFullYear(),m=f.excelMonth&&f.excelMonth>=1&&f.excelMonth<=12?f.excelMonth:D.getMonth()+1;n(f,v,m)},style:{...M,flex:2,background:"linear-gradient(135deg,#38a169,#2d6a4f)",color:"white",boxShadow:"0 4px 12px rgba(56,161,105,.3)"},children:"📥 このシートをインポート"})]})]})})}function ox({data:t,year:e,month:n,changeMonth:r,toggleTask:i,toggleSec:s,onEdit:o}){const l=t.sections||[],u=t.checked||{},h=t.openSecs||{},f=l.reduce((w,P)=>w+P.tasks.length,0),g=l.reduce((w,P)=>w+P.tasks.filter((N,b)=>u[`${P.id}:${b}`]).length,0),_=f?Math.round(g/f*100):0;return C.jsxs("div",{children:[C.jsxs("div",{style:{background:"linear-gradient(135deg,#1b4332,#2d6a4f 55%,#1b4332)",padding:"14px 18px 18px",position:"relative"},children:[C.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14,marginBottom:10,position:"relative",zIndex:1},children:[C.jsx("button",{onClick:()=>r(-1),style:{background:"rgba(255,255,255,.1)",border:"none",color:"rgba(255,255,255,.75)",width:30,height:30,borderRadius:"50%",cursor:"pointer",fontSize:16},children:"‹"}),C.jsxs("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:17,color:"#d4edda",fontWeight:600,textAlign:"center"},children:[e,"年 ",hE[n-1]]}),C.jsx("button",{onClick:()=>r(1),style:{background:"rgba(255,255,255,.1)",border:"none",color:"rgba(255,255,255,.75)",width:30,height:30,borderRadius:"50%",cursor:"pointer",fontSize:16},children:"›"})]}),C.jsxs("div",{style:{position:"relative",zIndex:1,marginBottom:10},children:[t.theme?C.jsxs("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:12,color:"#a8d8b9",marginBottom:5,lineHeight:1.6},children:["💕 ",t.theme]}):C.jsx("div",{style:{fontSize:11,color:"rgba(255,255,255,.3)",fontStyle:"italic"},children:"— 今月のテーマを設定してください —"}),C.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:4},children:(t.emotionTags||[]).map((w,P)=>C.jsx("span",{style:{background:"rgba(56,161,105,.2)",border:"1px solid rgba(56,161,105,.3)",color:"#a8d8b9",padding:"2px 8px",borderRadius:12,fontSize:10},children:w},P))})]}),C.jsxs("div",{style:{position:"relative",zIndex:1},children:[C.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:11,color:"rgba(255,255,255,.5)",marginBottom:4},children:[C.jsx("span",{children:"今月の達成率"}),C.jsxs("span",{style:{color:"#d4edda",fontWeight:700},children:[_,"% (",g,"/",f,")"]})]}),C.jsx("div",{style:{background:"rgba(255,255,255,.12)",borderRadius:6,height:7,overflow:"hidden"},children:C.jsx("div",{style:{height:"100%",borderRadius:6,width:`${_}%`,background:"linear-gradient(90deg,#38a169,#68d391)",transition:"width .7s"}})})]}),C.jsx("button",{onClick:o,style:{position:"absolute",bottom:16,right:18,background:"rgba(255,255,255,.1)",border:"1px solid rgba(255,255,255,.18)",color:"rgba(255,255,255,.75)",padding:"5px 12px",borderRadius:16,fontSize:11,fontFamily:"'Zen Maru Gothic',sans-serif",cursor:"pointer",zIndex:1},children:"✏️ 編集"})]}),C.jsxs("div",{style:{padding:"12px 12px 30px"},children:[(t.health||[]).some(w=>w.value)&&C.jsxs("div",{style:{background:"linear-gradient(135deg,#f0fdf4,#e8f5e9)",border:"1.5px solid #b7e4c7",borderRadius:14,padding:13,marginBottom:11,boxShadow:"0 2px 8px rgba(26,60,42,.06)"},children:[C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:12,fontWeight:700,color:"#2d6a4f",marginBottom:9},children:"💪 健康目標"}),C.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6},children:(t.health||[]).filter(w=>w.value).map((w,P)=>C.jsxs("div",{style:{background:"white",borderRadius:8,padding:"7px 10px",border:"1px solid rgba(56,161,105,.15)"},children:[C.jsx("div",{style:{fontSize:9,color:"#7aab8a",marginBottom:1},children:w.label}),C.jsx("div",{style:{fontSize:12,fontWeight:700,color:"#1a3c2a"},children:w.value})]},P))})]}),l.map(w=>{const P=hr[w.color]||hr.rose,N=w.tasks.filter((y,k)=>u[`${w.id}:${k}`]).length,b=w.tasks.length?Math.round(N/w.tasks.length*100):0,I=h[w.id]!==!1;return C.jsxs("div",{style:{background:"white",borderRadius:13,marginBottom:9,boxShadow:"0 2px 8px rgba(26,60,42,.06)",border:"1px solid rgba(56,161,105,.1)",overflow:"hidden"},children:[C.jsxs("div",{className:"sh",onClick:()=>s(w.id),style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"11px 13px",cursor:"pointer",userSelect:"none"},children:[C.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[C.jsx("div",{style:{width:30,height:30,borderRadius:8,background:P.bg,display:"flex",alignItems:"center",justifyContent:"center",fontSize:16},children:w.icon}),C.jsxs("div",{children:[C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:13,fontWeight:700,color:P.accent},children:w.name}),C.jsxs("div",{style:{fontSize:10,color:"#7aab8a",marginTop:1},children:[N," / ",w.tasks.length," 完了"]})]})]}),C.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[C.jsx("div",{style:{width:42,height:5,borderRadius:3,background:"rgba(26,60,42,.08)",overflow:"hidden"},children:C.jsx("div",{style:{height:"100%",borderRadius:3,width:`${b}%`,background:P.accent,transition:"width .4s"}})}),C.jsx("div",{style:{fontSize:10,color:"#7aab8a",transform:I?"rotate(180deg)":"rotate(0)",transition:"transform .25s"},children:"▼"})]})]}),I&&C.jsx("div",{className:"sb",style:{padding:"2px 13px 10px",borderTop:"1px solid rgba(56,161,105,.09)"},children:w.tasks.length===0?C.jsx("div",{style:{fontSize:12,color:"#7aab8a",padding:"10px 4px",fontStyle:"italic"},children:"タスクがありません。✏️ 編集から追加してください。"}):w.tasks.map((y,k)=>{const O=!!u[`${w.id}:${k}`];return C.jsxs("div",{className:"rh",onClick:()=>i(w.id,k),style:{display:"flex",alignItems:"flex-start",gap:8,padding:"8px 4px",borderBottom:k<w.tasks.length-1?"1px solid rgba(56,161,105,.08)":"none",cursor:"pointer"},children:[C.jsx("div",{style:{width:20,height:20,borderRadius:6,flexShrink:0,marginTop:1,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:700,color:"white",background:O?P.accent:"transparent",border:O?`2px solid ${P.accent}`:"2px solid #b7e4c7",transition:"all .2s"},children:O?"✓":""}),C.jsx("div",{style:{fontSize:13,lineHeight:1.55,flex:1,color:O?"#7aab8a":"#1a3c2a",textDecoration:O?"line-through":"none"},children:y})]},k)})})]},w.id)}),C.jsx("div",{style:{textAlign:"center",fontSize:11,color:"#7aab8a",paddingTop:6},children:"✨ タップでチェック ／ セクションをタップで折りたたみ"})]})]})}function ax({visionKey:t}){const e=rx[t];if(!e)return null;const[n,r]=J.useState(Object.fromEntries(e.sections.map(i=>[i.id,!0])));return C.jsxs("div",{children:[C.jsxs("div",{style:{background:"linear-gradient(135deg,#1b4332,#2d6a4f 55%,#1b4332)",padding:"16px 18px 18px"},children:[C.jsxs("div",{style:{textAlign:"center",marginBottom:10},children:[C.jsx("div",{style:{fontSize:32,marginBottom:4},children:e.icon}),C.jsxs("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:18,fontWeight:700,color:"#d4edda"},children:[e.title,"のビジョン"]}),C.jsx("div",{style:{fontSize:12,color:"rgba(255,255,255,.55)",marginTop:2},children:e.subtitle})]}),C.jsxs("div",{style:{background:"rgba(255,255,255,.08)",borderRadius:10,padding:"10px 14px",fontSize:12,color:"#a8d8b9",lineHeight:1.7,textAlign:"center",fontFamily:"'Shippori Mincho',serif"},children:["💕 ",e.theme]})]}),C.jsx("div",{style:{padding:"12px 12px 30px"},children:e.sections.map(i=>{const s=hr[i.color]||hr.rose,o=n[i.id]!==!1;return C.jsxs("div",{style:{background:"white",borderRadius:13,marginBottom:9,boxShadow:"0 2px 8px rgba(26,60,42,.06)",border:"1px solid rgba(56,161,105,.1)",overflow:"hidden"},children:[C.jsxs("div",{className:"sh",onClick:()=>r(l=>({...l,[i.id]:!l[i.id]})),style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"11px 13px",cursor:"pointer",userSelect:"none"},children:[C.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[C.jsx("div",{style:{width:30,height:30,borderRadius:8,background:s.bg,display:"flex",alignItems:"center",justifyContent:"center",fontSize:16},children:i.icon}),C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:13,fontWeight:700,color:s.accent},children:i.name})]}),C.jsx("div",{style:{fontSize:10,color:"#7aab8a",transform:o?"rotate(180deg)":"rotate(0)",transition:"transform .25s"},children:"▼"})]}),o&&C.jsx("div",{className:"sb",style:{padding:"4px 13px 12px",borderTop:"1px solid rgba(56,161,105,.09)"},children:i.content.split(`
`).map((l,u)=>C.jsx("div",{style:{fontSize:13,lineHeight:1.7,color:"#1a3c2a",padding:"3px 0",borderBottom:u<i.content.split(`
`).length-1?"1px solid rgba(56,161,105,.06)":"none"},children:l},u))})]},i.id)})})]})}function lx(){const[t,e]=J.useState("login"),[n,r]=J.useState(""),[i,s]=J.useState(""),[o,l]=J.useState(""),[u,h]=J.useState(""),[f,g]=J.useState(!1),_={"auth/email-already-in-use":"このメールアドレスは既に登録されています","auth/invalid-email":"メールアドレスの形式が正しくありません","auth/weak-password":"パスワードは6文字以上にしてください","auth/user-not-found":"メールアドレスまたはパスワードが間違っています","auth/wrong-password":"メールアドレスまたはパスワードが間違っています","auth/invalid-credential":"メールアドレスまたはパスワードが間違っています","auth/too-many-requests":"しばらく時間をおいてからお試しください"},w=async()=>{l(""),h(""),g(!0);try{t==="register"?await Q1(Ls,n,i):t==="login"?await Y1(Ls,n,i):(await G1(Ls,n),h("パスワードリセットメールを送信しました"))}catch(I){l(_[I.code]||"エラーが発生しました")}g(!1)},P={width:"100%",padding:"12px 14px",borderRadius:10,fontSize:14,fontFamily:"'Zen Maru Gothic',sans-serif",color:"#1a3c2a",border:"1.5px solid #b7e4c7",background:"white",outline:"none",marginBottom:10,display:"block"},N={login:"ログイン",register:"新規登録",reset:"パスワードをリセット"},b={login:"ログイン",register:"登録する",reset:"リセットメールを送信"};return C.jsxs("div",{style:{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#f1f8f4",fontFamily:"'Zen Maru Gothic',sans-serif",padding:24},children:[C.jsx("style",{children:"@import url('https://fonts.googleapis.com/css2?family=Zen+Maru+Gothic:wght@400;700&family=Shippori+Mincho:wght@700&display=swap');"}),C.jsxs("div",{style:{width:"100%",maxWidth:380},children:[C.jsxs("div",{style:{textAlign:"center",marginBottom:28},children:[C.jsx("div",{style:{fontSize:48,marginBottom:10},children:"🌿"}),C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:22,fontWeight:700,color:"#1a3c2a",marginBottom:4},children:"フューチャーマップ"}),C.jsxs("div",{style:{fontSize:12,color:"#7aab8a",lineHeight:1.7},children:["毎月の目標を管理して",C.jsx("br",{}),"「愛し愛される人生」を実現する"]})]}),C.jsxs("div",{style:{background:"white",borderRadius:18,padding:"24px 22px",boxShadow:"0 4px 24px rgba(56,161,105,.12)",border:"1px solid #d4edda"},children:[C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:16,fontWeight:700,color:"#2d6a4f",marginBottom:18,textAlign:"center"},children:N[t]}),C.jsx("input",{type:"email",placeholder:"メールアドレス",value:n,onChange:I=>r(I.target.value),style:P,onKeyDown:I=>I.key==="Enter"&&w()}),t!=="reset"&&C.jsx("input",{type:"password",placeholder:"パスワード（6文字以上）",value:i,onChange:I=>s(I.target.value),style:P,onKeyDown:I=>I.key==="Enter"&&w()}),o&&C.jsx("div",{style:{fontSize:12,color:"#e53e3e",marginBottom:10,background:"#fff5f5",borderRadius:8,padding:"8px 12px"},children:o}),u&&C.jsx("div",{style:{fontSize:12,color:"#2d6a4f",marginBottom:10,background:"#f0fdf4",borderRadius:8,padding:"8px 12px"},children:u}),C.jsx("button",{onClick:w,disabled:f,style:{width:"100%",background:"linear-gradient(135deg,#38a169,#2d6a4f)",color:"white",border:"none",borderRadius:11,padding:"13px",fontSize:14,fontWeight:700,fontFamily:"'Zen Maru Gothic',sans-serif",cursor:f?"default":"pointer",boxShadow:"0 4px 14px rgba(56,161,105,.3)",marginBottom:14,opacity:f?.7:1},children:f?"処理中...":b[t]}),C.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:8,alignItems:"center"},children:[t==="login"&&C.jsxs(C.Fragment,{children:[C.jsx("button",{onClick:()=>{e("register"),l(""),h("")},style:{background:"none",border:"none",color:"#38a169",fontSize:13,cursor:"pointer",fontFamily:"'Zen Maru Gothic',sans-serif"},children:"アカウントをお持ちでない方はこちら →"}),C.jsx("button",{onClick:()=>{e("reset"),l(""),h("")},style:{background:"none",border:"none",color:"#7aab8a",fontSize:12,cursor:"pointer",fontFamily:"'Zen Maru Gothic',sans-serif"},children:"パスワードをお忘れの方"})]}),t!=="login"&&C.jsx("button",{onClick:()=>{e("login"),l(""),h("")},style:{background:"none",border:"none",color:"#38a169",fontSize:13,cursor:"pointer",fontFamily:"'Zen Maru Gothic',sans-serif"},children:"← ログインに戻る"})]})]})]})]})}function jg({msg:t}){return C.jsxs("div",{style:{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#f1f8f4",fontFamily:"'Zen Maru Gothic',sans-serif",color:"#7aab8a",fontSize:14},children:["🌿 ",t]})}function ux({data:t,onSave:e,onClose:n}){const[r,i]=J.useState("tasks"),[s,o]=J.useState(t.theme||""),[l,u]=J.useState(t.themeSub||""),[h,f]=J.useState((t.emotionTags||[]).join("、")),[g,_]=J.useState((t.health||[]).map(y=>`${y.label}: ${y.value}`).join(`
`)),[w,P]=J.useState(Object.fromEntries((t.sections||[]).map(y=>[y.id,y.tasks.join(`
`)]))),N=()=>{const y=h.split(/[、,，]/).map(D=>D.trim()).filter(Boolean),k=g.split(`
`).map(D=>{const v=D.indexOf(":");return v<0?{label:D.trim(),value:""}:{label:D.slice(0,v).trim(),value:D.slice(v+1).trim()}}).filter(D=>D.label),O=(t.sections||[]).map(D=>({...D,tasks:(w[D.id]||"").split(`
`).map(v=>v.trim()).filter(Boolean)})),M={...t.checked||{}};O.forEach(D=>{const v=(t.sections||[]).find(m=>m.id===D.id);if(v)for(let m=D.tasks.length;m<v.tasks.length;m++)delete M[`${D.id}:${m}`]}),e({theme:s,themeSub:l,emotionTags:y,health:k,sections:O,checked:M})},b=[{id:"tasks",label:"📋 タスク"},{id:"health",label:"💪 健康"},{id:"theme",label:"💭 テーマ"}],I={width:"100%",border:"1.5px solid #b7e4c7",borderRadius:9,padding:"9px 11px",fontSize:12,fontFamily:"'Zen Maru Gothic',sans-serif",color:"#1a3c2a",background:"white",resize:"vertical",lineHeight:1.8,display:"block"};return C.jsx("div",{onClick:y=>y.target===y.currentTarget&&n(),style:{position:"fixed",inset:0,background:"rgba(26,60,42,.55)",zIndex:500,display:"flex",alignItems:"flex-end",justifyContent:"center"},children:C.jsxs("div",{className:"mi",style:{background:"#f4fbf6",borderRadius:"22px 22px 0 0",width:"100%",maxWidth:640,maxHeight:"90vh",overflow:"hidden",display:"flex",flexDirection:"column"},children:[C.jsx("div",{style:{width:38,height:4,background:"#7aab8a",borderRadius:2,margin:"14px auto 0",opacity:.4}}),C.jsxs("div",{style:{padding:"12px 18px 0"},children:[C.jsx("div",{style:{fontFamily:"'Shippori Mincho',serif",fontSize:16,fontWeight:700,color:"#2d6a4f",marginBottom:10},children:"✏️ 今月の目標を編集"}),C.jsx("div",{style:{display:"flex",gap:5,marginBottom:12},children:b.map(y=>C.jsx("button",{onClick:()=>i(y.id),style:{padding:"5px 13px",borderRadius:18,border:"none",cursor:"pointer",fontSize:11,fontFamily:"'Zen Maru Gothic',sans-serif",fontWeight:600,background:r===y.id?"#38a169":"rgba(26,60,42,.07)",color:r===y.id?"white":"#2d5a3d",transition:"all .2s"},children:y.label},y.id))})]}),C.jsxs("div",{style:{overflowY:"auto",padding:"0 18px 18px",flex:1},children:[r==="theme"&&[{label:"今月のテーマ",val:s,set:o,rows:2,hint:""},{label:"サブテーマ",val:l,set:u,rows:2,hint:""},{label:"感情タグ（カンマ・読点区切り）",val:h,set:f,rows:2,hint:"例: ワクワク、幸せ、ツイてる♪"}].map(y=>C.jsxs("div",{style:{marginBottom:14},children:[C.jsx("div",{style:{fontSize:12,fontWeight:700,color:"#2d5a3d",marginBottom:5},children:y.label}),C.jsx("textarea",{value:y.val,onChange:k=>y.set(k.target.value),rows:y.rows,style:I}),y.hint&&C.jsx("div",{style:{fontSize:10,color:"#7aab8a",marginTop:2},children:y.hint})]},y.label)),r==="health"&&C.jsxs("div",{style:{marginBottom:14},children:[C.jsx("div",{style:{fontSize:12,fontWeight:700,color:"#2d5a3d",marginBottom:5},children:"健康目標（各行: ラベル: 値）"}),C.jsx("textarea",{value:g,onChange:y=>_(y.target.value),rows:10,style:I}),C.jsx("div",{style:{fontSize:10,color:"#7aab8a",marginTop:2},children:"例: 就寝: 22:00"})]}),r==="tasks"&&(t.sections||[]).map(y=>{const k=hr[y.color]||hr.rose;return C.jsxs("div",{style:{marginBottom:16},children:[C.jsxs("div",{style:{fontSize:12,fontWeight:700,color:k.accent,marginBottom:5,display:"flex",alignItems:"center",gap:4},children:[y.icon," ",y.name]}),C.jsx("textarea",{value:w[y.id]||"",onChange:O=>P(M=>({...M,[y.id]:O.target.value})),rows:Math.max(3,(w[y.id]||"").split(`
`).length+1),style:I}),C.jsx("div",{style:{fontSize:10,color:"#7aab8a",marginTop:2},children:"1行に1タスク"})]},y.id)})]}),C.jsxs("div",{style:{padding:"10px 18px 30px",display:"flex",gap:9,borderTop:"1px solid rgba(56,161,105,.13)"},children:[C.jsx("button",{onClick:n,style:{background:"rgba(26,60,42,.07)",color:"#2d5a3d",border:"none",borderRadius:11,padding:"11px 18px",fontSize:13,fontFamily:"'Zen Maru Gothic',sans-serif",cursor:"pointer"},children:"キャンセル"}),C.jsx("button",{onClick:N,style:{flex:1,background:"linear-gradient(135deg,#38a169,#2d6a4f)",color:"white",border:"none",borderRadius:11,padding:"11px",fontSize:13,fontWeight:700,fontFamily:"'Zen Maru Gothic',sans-serif",cursor:"pointer",boxShadow:"0 4px 12px rgba(56,161,105,.3)"},children:"💾 保存する"})]})]})})}cc.createRoot(document.getElementById("root")).render(C.jsx(ow.StrictMode,{children:C.jsx(ix,{})}));
